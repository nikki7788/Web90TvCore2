...
{
    public partial class Mig10the_poll_and_PollOptions_tbl_created : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NewsPlace = table.Column<byte>(nullable: false),
                    NewsTime = table.Column<string>(nullable: true),
                    NewsType = table.Column<byte>(nullable: false),
